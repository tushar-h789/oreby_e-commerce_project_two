...
const Products = ({src, badge}) => {
  return (
    <div >
        ...
        <div className='bg-white md:bottom-[-42%] bottom-[-42%]  md:max-xl:bottom-[-62%] group-hover:bottom-0 h-40 absolute bottom-0 left-0 w-full py-6 px-7 ease-in duration-300'>
